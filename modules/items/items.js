...
function Items() {
  ...
  function _getTable(version, filter) {
    ...
    for (var i in items) {
      ...
      if (item.name.en_US.toLowerCase().indexOf(filter.toLowerCase()) !== -1) {
        tableString += "<tr><td>" + i + "</td><td>";
        tableString +=
          "<img class='item-entry-icon " +
        ...
        tableString +=
          "<span class=" + '"item-entry-text">' + item.name.en_US + "</td><td>";
        ...
        if (item.params !== undefined) {
          ...
          if (params.attack !== undefined) {
            ...
            tableString +=
              ...
              "' src='" +
              globals.imageData.getImage(version, "items", "attack") +
              "'/> <span class=" +
              "'item-entry-text'>" +
              params.attack +
              "</span>";
          ...
          if (params.defense !== undefined) {
            ...
            tableString +=
              ...
              "' src='" +
              globals.imageData.getImage(version, "items", "def" + "ense") +
              "'/> <span class=" +
              "'item-entry-text'>" +
              params.defense +
              "</span>";
          ...
          if (params.focus !== undefined) {
            ...
            tableString +=
              ...
              (version + " items focus") +
              "' src='" +
              globals.imageData.getImage(version, "items", "focus") +
              "'/> <span class=" +
              "'item-entry-text'>" +
              params.focus +
              "</span>";
