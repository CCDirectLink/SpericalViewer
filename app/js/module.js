...
function Module(initLang, langFile){
	...
	this.getLangData = function() {
		if ((!langStore[instance
			.selectedLang.langId]) ||
			(!langStore[instance
				.selectedLang.langId][instance
				.selectedLang.langIdSub])) {
			return {};
		}
	...
	this.setLang = function(langIdOrObject, langIdSub) {
		...
		if ((langIdOrObject) && (langIdSub) &&
			...
			instance.selectedLang.langId = langIdOrObject
				.langId;
			instance.selectedLang.langIdSub = langIdOrObject
				.langIdSub;
		}

		for (let id in callbacks.langChanged) {
			callbacks.langChanged[id].apply(
				this,
				[
					...arguments,
					langStore[instance
